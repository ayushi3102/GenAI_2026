...
def chat_with_ai(messages,temp,tokens):
    resp = client.responses.create(model="gpt-5.1",input = messages,temperature = temp,max_output_tokens = tokens)
    return resp
...
try:
    ...
    while True:
        ...
        ai_response = chat_with_ai(messages,0.2,50)
